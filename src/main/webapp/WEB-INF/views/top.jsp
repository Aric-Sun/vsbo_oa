        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs pl15"> ${map.ename} </span>
                    <span class="caret caret-tp hidden-xs"></span>
                </a>
                <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
                    <li class="list-group-item">
                        <a href="/oa/self.do" class="animated animated-short fadeInUp">
                            <span class="fa fa-user"></span> 个人信息
                            <span class="label label-warning"></span>
                        </a>
                    </li>
                    <li class="list-group-item">
                        <a href="/oa/to_changePwd.do" class="animated animated-short fadeInUp">
                            <span class="fa fa-gear"></span> 设置密码 </a>
                    </li>
                    <li class="dropdown-footer">
                        <a href="/oa/quit.do" class="">
    ...
    <aside id="sidebar_left" class="nano nano-light affix">
        <div class="sidebar-left-content nano-content">
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="media-author">${map.ename}--${map.job}</div>
                            <div class="media-links">
                                <a href="/oa/quit.do">退出</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <ul class="nav sidebar-menu">
                ...
                <li>
                    <a href="/oa/getExpenceAccountForNext.do">
                ...
                <li class="active">
                    <a href="/oa/getExpenceAccountForSelf.do">
                        <span class="glyphicon glyphicon-home"></span>
                        <span class="sidebar-title">个人报销单</span>
                    </a>
                </li>
                <li>
                    <a href="/oa/to_addExpence.do">
