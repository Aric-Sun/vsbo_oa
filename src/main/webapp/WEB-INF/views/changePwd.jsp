    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form method="post" action="/oa/changePwd.do" id="admin-form">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="old" class="field prepend-icon">
                                    <input type="password" name="oldPwd" id="old" class="gui-input" placeholder="原始密码...">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="new1" class="field prepend-icon">
                                    <input type="password" name="newPwd1" id="new1" class="gui-input" placeholder="新密码...">
                            ...
                            <div class="col-md-6">
                                <label for="new2" class="field prepend-icon">
                                    <input type="password" name="newPwd2" id="new2" class="gui-input" placeholder="重复密码...">
